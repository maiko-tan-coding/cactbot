...
| <img src="../../resources/ffxiv/jobs/drk-large.png" width="30px" /><br> 暗黑骑士 | Shows the blood amount and darkside time, BloodWeapon&Delirium&LivingShadow duration and cooldown, and shows combo time remaining. |
...
|  <img src="../../resources/ffxiv/jobs/sam-large.png" width="30px" /><br> 武士  |  Shows Kenki amount, Meditation stacks, Shifu&Jinpu&Higanbana duration, Tsubame-gaeshi cooldown, and shows combo time remaining.   |
